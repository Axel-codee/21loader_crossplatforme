...
| `BACKLOG-29` | Bouton de mise a jour web detectant la derniere release GitHub et lancant <21loader update> | `done 2026-06-09` | frontend-ui / distribution | [../domains/frontend-ui.md](../domains/frontend-ui.md), [../solutions/terminal-cli-github-release-updater.md](../solutions/terminal-cli-github-release-updater.md) |
...
- `BACKLOG-29` a ete traite le `2026-06-09`; un bouton dans l'en-tete web permet de rechercher la derniere GitHub Release via `GET /api/app/update/check` et de lancer la mise a jour via `POST /api/app/update/latest`, en reutilisant le flux `21loader update`.
